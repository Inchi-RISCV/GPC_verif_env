...
module HellaCacheArbiter(
  input         clock,
                io_requestor_0_req_valid,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
  ...
  input         io_requestor_0_req_bits_dv,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
                ...
                io_requestor_1_req_valid,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
  ...
  input         io_requestor_1_req_bits_dv,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
                ...
                io_requestor_1_asid,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
  ...
  output        io_requestor_0_s2_xcpt_ae_ld,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
                ...
                io_requestor_1_s2_nack,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
                io_requestor_1_resp_valid,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
  ...
  output        io_requestor_1_replay_next,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
                ...
                io_requestor_1_ordered,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
  ...
  output        io_mem_req_bits_dv,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
                ...
                io_mem_asid,	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14
  ...
  wire tag_hit_1 = io_mem_resp_bits_tag[0];	// src/main/scala/rocket/HellaCacheArbiter.scala:61:{41,57}
  wire tag_hit = ~tag_hit_1;	// src/main/scala/rocket/HellaCacheArbiter.scala:61:57
  always @(posedge clock) begin
    s1_id <= ~io_requestor_0_req_valid;	// src/main/scala/rocket/HellaCacheArbiter.scala:20:20, :35:35, :36:15, :51:26
  ...
  assign io_requestor_0_s2_nack = io_mem_s2_nack & ~s2_id;	// src/main/scala/rocket/HellaCacheArbiter.scala:21:24, :53:21, :68:49
  assign io_requestor_0_resp_valid = io_mem_resp_valid & tag_hit;	// src/main/scala/rocket/HellaCacheArbiter.scala:61:57, :62:39
  assign io_requestor_0_resp_bits_data = io_mem_resp_bits_data;
  assign io_requestor_0_s2_xcpt_ae_ld = io_mem_s2_xcpt_ae_ld;
  assign io_requestor_1_req_ready = io_mem_req_ready & ~io_requestor_0_req_valid;	// src/main/scala/rocket/HellaCacheArbiter.scala:28:{64,67}
  assign io_requestor_1_s2_nack = io_mem_s2_nack & s2_id;	// src/main/scala/rocket/HellaCacheArbiter.scala:21:24, :68:49
  assign io_requestor_1_resp_valid = io_mem_resp_valid & tag_hit_1;	// src/main/scala/rocket/HellaCacheArbiter.scala:61:57, :62:39
  assign io_requestor_1_resp_bits_tag = {1'h0, io_mem_resp_bits_tag[6:1]};	// src/main/scala/rocket/HellaCacheArbiter.scala:74:{21,45}
  ...
  assign io_mem_req_bits_addr =
    io_requestor_0_req_valid
      ...
      : io_requestor_1_req_bits_addr;	// src/main/scala/rocket/HellaCacheArbiter.scala:33:25, :51:26
  assign io_mem_req_bits_tag =
    io_requestor_0_req_valid ? 7'h0 : {io_requestor_1_req_bits_tag[5:0], 1'h1};	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14, :35:29, :51:26
  assign io_mem_req_bits_cmd =
    io_requestor_0_req_valid ? 5'h0 : io_requestor_1_req_bits_cmd;	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14, :33:25, :51:26
  assign io_mem_req_bits_size =
    io_requestor_0_req_valid ? 2'h3 : io_requestor_1_req_bits_size;	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14, :33:25, :51:26
  assign io_mem_req_bits_signed =
    ~io_requestor_0_req_valid & io_requestor_1_req_bits_signed;	// src/main/scala/rocket/HellaCacheArbiter.scala:33:25, :51:26
  assign io_mem_req_bits_dprv =
    io_requestor_0_req_valid ? 2'h1 : io_requestor_1_req_bits_dprv;	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14, :33:25, :51:26
  assign io_mem_req_bits_dv =
    io_requestor_0_req_valid ? io_requestor_0_req_bits_dv : io_requestor_1_req_bits_dv;	// src/main/scala/rocket/HellaCacheArbiter.scala:33:25, :51:26
  assign io_mem_req_bits_phys = io_requestor_0_req_valid;
  assign io_mem_s1_kill = s1_id ? io_requestor_1_s1_kill : io_requestor_0_s1_kill;	// src/main/scala/rocket/HellaCacheArbiter.scala:20:20, :39:24, :52:30
  assign io_mem_asid = ~io_requestor_0_req_valid & io_requestor_1_asid;	// src/main/scala/rocket/HellaCacheArbiter.scala:33:25, :34:21, :51:26
  assign io_mem_s1_data_data = s1_id ? io_requestor_1_s1_data_data : 64'h0;	// src/main/scala/rocket/HellaCacheArbiter.scala:12:14, :20:20, :33:25, :40:24, :51:26, :52:30
endmodule
