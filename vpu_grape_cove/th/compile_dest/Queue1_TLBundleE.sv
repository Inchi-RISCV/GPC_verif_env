...
module Queue1_TLBundleE(
  ...
  reg  [1:0] ram_sink;	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  ...
  always @(posedge clock) begin
    if (do_enq)	// src/main/scala/chisel3/util/Decoupled.scala:264:27
      ram_sink <= io_enq_bits_sink;	// src/main/scala/chisel3/util/Decoupled.scala:257:91
    if (reset)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram_sink = _RANDOM[/*Zero width*/ 1'b0][2:1];	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  ...
  assign io_deq_bits_sink = ram_sink;	// src/main/scala/chisel3/util/Decoupled.scala:257:91
endmodule
