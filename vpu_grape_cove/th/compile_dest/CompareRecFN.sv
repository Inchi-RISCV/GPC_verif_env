...
module CompareRecFN(
  ...
  wire [53:0] rawA_sig = {1'h0, ~rawA_isZero, io_a[51:0]};	// dependencies/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:52:53, :55:23, :61:{35,44,49}
  ...
  wire [53:0] rawB_sig = {1'h0, ~rawB_isZero, io_b[51:0]};	// dependencies/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:52:53, :55:23, :61:{35,44,49}
  ...
  wire        invalid =
    rawA_isNaN & ~(rawA_sig[51]) | rawB_isNaN & ~(rawB_sig[51]) | io_signaling & ~ordered;	// dependencies/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:57:32, :75:58, :76:{27,30}, dependencies/hardfloat/hardfloat/src/main/scala/common.scala:82:{46,49,56}, dependencies/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:55:23
  assign io_lt = ordered & ordered_lt;	// dependencies/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:57:32, :66:21, :78:22
  assign io_eq = ordered & ordered_eq;	// dependencies/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:57:32, :72:19, :79:22
  assign io_exceptionFlags = {invalid, 4'h0};	// dependencies/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:75:58, :81:34
endmodule
