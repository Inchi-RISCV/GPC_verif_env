...
module Queue9_BundleMap(
  ...
  wire [11:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  ...
  wire        wrap = enq_ptr_value == 4'h8;	// src/main/scala/chisel3/util/Counter.scala:61:40, :73:24
  wire        wrap_1 = deq_ptr_value == 4'h8;	// src/main/scala/chisel3/util/Counter.scala:61:40, :73:24
  wire [3:0]  ptr_diff = enq_ptr_value - deq_ptr_value;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:310:32
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (do_enq) begin	// src/main/scala/chisel3/util/Decoupled.scala:264:27
      ...
      if (do_deq) begin	// src/main/scala/chisel3/util/Decoupled.scala:265:27
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        maybe_full = _RANDOM[/*Zero width*/ 1'b0][8];	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:260:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_9x12 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  ...
  assign io_deq_bits_tl_state_size = _ram_ext_R0_data[3:0];	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  assign io_deq_bits_tl_state_source = _ram_ext_R0_data[10:4];	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  assign io_deq_bits_extra_id = _ram_ext_R0_data[11];	// src/main/scala/chisel3/util/Decoupled.scala:257:91
endmodule
