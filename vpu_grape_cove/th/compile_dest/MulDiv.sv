...
module MulDiv(
  ...
  wire         lhs_sign =
    lhsSigned & (io_req_bits_dw ? io_req_bits_in1[63] : io_req_bits_in1[31]);	// src/main/scala/rocket/Multiplier.scala:72:107, :78:{23,29,38,48}
  wire [31:0]  hi = io_req_bits_dw ? io_req_bits_in1[63:32] : {32{lhs_sign}};	// src/main/scala/rocket/Multiplier.scala:78:23, :79:{17,29,43}
  wire [63:0]  lhs_in = {hi, io_req_bits_in1[31:0]};	// src/main/scala/rocket/Multiplier.scala:79:17, :80:{9,15}
  wire         rhs_sign =
    rhsSigned & (io_req_bits_dw ? io_req_bits_in2[63] : io_req_bits_in2[31]);	// src/main/scala/rocket/Multiplier.scala:72:107, :78:{23,29,38,48}
  wire [31:0]  hi_1 = io_req_bits_dw ? io_req_bits_in2[63:32] : {32{rhs_sign}};	// src/main/scala/rocket/Multiplier.scala:78:23, :79:{17,29,43}
  wire [63:0]  rhs_in = {hi_1, io_req_bits_in2[31:0]};	// src/main/scala/rocket/Multiplier.scala:79:17, :80:{9,15}
  ...
  wire         _io_resp_valid_output = state == 3'h6 | (&state);	// src/main/scala/rocket/Multiplier.scala:48:22, :111:32, :178:{27,42,51}
  ...
  always @(posedge clock) begin
    ...
    _GEN_5 = _io_req_ready_output & io_req_valid;	// src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/rocket/Multiplier.scala:179:25
    if (reset)
      state <= 3'h0;	// src/main/scala/rocket/Multiplier.scala:48:22
    else if (_GEN_5) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
      if (cmdMul)	// src/main/scala/rocket/Multiplier.scala:72:107
        state <= 3'h2;	// src/main/scala/rocket/Multiplier.scala:48:22, :103:39
      else	// src/main/scala/rocket/Multiplier.scala:72:107
        state <= {1'h0, ~(lhs_sign | rhs_sign), 1'h1};	// src/main/scala/rocket/Multiplier.scala:48:22, :50:16, :75:50, :78:23, :162:{36,46}
    end
    ...
    if (_GEN_5) begin	// src/main/scala/chisel3/util/Decoupled.scala:52:35
      ...
      count <= {4'h0, cmdMul & ~io_req_bits_dw, 2'h0};	// src/main/scala/chisel3/util/pla.scala:114:36, src/main/scala/rocket/Multiplier.scala:51:18, :72:107, :75:60, :165:{11,46}
