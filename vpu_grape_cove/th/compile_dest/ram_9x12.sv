...
module ram_9x12(	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  input  [3:0]  R0_addr,
  input         R0_en,
                R0_clk,
  input  [3:0]  W0_addr,
  ...
  reg [11:0] Memory[0:8];	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 12'bx;	// src/main/scala/chisel3/util/Decoupled.scala:257:91
endmodule
