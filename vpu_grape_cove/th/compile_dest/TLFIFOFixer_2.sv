...
module TLFIFOFixer_2(
  ...
  wire        a_id = ~(nodeIn_a_bits_address[31]);	// src/main/scala/chisel3/util/Mux.scala:30:73, src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/diplomacy/Parameters.scala:137:{41,46,59}
  ...
  wire [15:0] SourceIdSet = _GEN ? 16'h1 << nodeIn_a_bits_source : 16'h0;	// src/main/scala/chisel3/util/OneHot.scala:58:35, src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:74:21, :109:35, :110:36, :113:50, :114:21
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      flight_0 <=
        ...
        & (_GEN & nodeIn_a_bits_source == 4'h0 | flight_0);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_1 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'h1)
        & (_GEN & nodeIn_a_bits_source == 4'h1 | flight_1);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_2 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'h2)
        & (_GEN & nodeIn_a_bits_source == 4'h2 | flight_2);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_3 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'h3)
        & (_GEN & nodeIn_a_bits_source == 4'h3 | flight_3);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_4 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'h4)
        & (_GEN & nodeIn_a_bits_source == 4'h4 | flight_4);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_5 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'h5)
        & (_GEN & nodeIn_a_bits_source == 4'h5 | flight_5);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_6 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'h6)
        & (_GEN & nodeIn_a_bits_source == 4'h6 | flight_6);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_7 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'h7)
        & (_GEN & nodeIn_a_bits_source == 4'h7 | flight_7);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_8 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'h8)
        & (_GEN & nodeIn_a_bits_source == 4'h8 | flight_8);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_9 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'h9)
        & (_GEN & nodeIn_a_bits_source == 4'h9 | flight_9);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_10 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'hA)
        & (_GEN & nodeIn_a_bits_source == 4'hA | flight_10);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_11 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'hB)
        & (_GEN & nodeIn_a_bits_source == 4'hB | flight_11);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_12 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'hC)
        & (_GEN & nodeIn_a_bits_source == 4'hC | flight_12);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_13 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'hD)
        & (_GEN & nodeIn_a_bits_source == 4'hD | flight_13);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_14 <=
        ~(_GEN_0 & nodeIn_d_bits_source == 4'hE)
        & (_GEN & nodeIn_a_bits_source == 4'hE | flight_14);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
      flight_15 <=
        ~(_GEN_0 & (&nodeIn_d_bits_source))
        & (_GEN & (&nodeIn_a_bits_source) | flight_15);	// src/main/scala/diplomacy/Nodes.scala:1214:17, src/main/scala/tilelink/FIFOFixer.scala:73:27, :74:{21,35,62}, :75:{21,35,62}
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stalls_id = _RANDOM[1'h1][2];	// src/main/scala/tilelink/FIFOFixer.scala:73:27, :79:30
        stalls_id_1 = _RANDOM[1'h1][3];	// src/main/scala/tilelink/FIFOFixer.scala:73:27, :79:30
        SourceIdFIFOed = _RANDOM[1'h1][19:4];	// src/main/scala/tilelink/FIFOFixer.scala:73:27, :109:35
      `endif // RANDOMIZE_REG_INIT
    end // initial
