  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = {_RANDOM[2'h0][31:17], _RANDOM[2'h1][10:0]};	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_mask = _RANDOM[2'h1][18:11];	// src/main/scala/util/Repeater.scala:20:18
        saved_data = {_RANDOM[2'h1][31:19], _RANDOM[2'h2], _RANDOM[2'h3][18:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_corrupt = _RANDOM[2'h3][19];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
