...
module WritebackEntry_2(
  ...
  wire [4:0]   release_source = 5'hA;	// src/main/scala/tilelink/Edges.scala:381:17
  wire [4:0]   releaseData_source = 5'hA;	// src/main/scala/tilelink/Edges.scala:397:17
  ...
  assign io_release_bits_source =
    reqReg_voluntary ? 5'hA : reqReg_hasData ? probeAckData_source : probeAck_source;	// src/main/scala/gpcdcache/WritebackQueue.scala:46:25, :137:25, :140:8, src/main/scala/tilelink/Edges.scala:417:17, :434:17
