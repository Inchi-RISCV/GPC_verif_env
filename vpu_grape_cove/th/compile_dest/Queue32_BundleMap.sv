...
module Queue32_BundleMap(
  ...
  input  [8:0] io_enq_bits_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:256:14
  input  [4:0] io_enq_bits_extra_id,	// src/main/scala/chisel3/util/Decoupled.scala:256:14
  ...
  output [8:0] io_deq_bits_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:256:14
  output [4:0] io_deq_bits_extra_id	// src/main/scala/chisel3/util/Decoupled.scala:256:14
);

  wire [17:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  ...
  wire [4:0]  ptr_diff = enq_ptr_value - deq_ptr_value;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:310:32
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        maybe_full = _RANDOM[/*Zero width*/ 1'b0][10];	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:260:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_32x18 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  ...
  assign io_deq_bits_tl_state_source = _ram_ext_R0_data[12:4];	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  assign io_deq_bits_extra_id = _ram_ext_R0_data[17:13];	// src/main/scala/chisel3/util/Decoupled.scala:257:91
endmodule
