...
module ALU(
  ...
  wire [63:0] _io_adder_out_T_3 = io_in1 + in2_inv + {63'h0, io_fn[3]};	// src/main/scala/rocket/ALU.scala:43:29, :69:20, :71:36, :105:50
  wire        slt =
    io_in1[63] == io_in2[63] ? _io_adder_out_T_3[63] : io_fn[1] ? io_in2[63] : io_in1[63];	// src/main/scala/rocket/ALU.scala:45:35, :71:36, :75:{8,15,24,34,56}, :76:8
  ...
  wire [63:0] out = io_fn == 4'h0 | io_fn == 4'hA ? _io_adder_out_T_3 : shift_logic;	// src/main/scala/rocket/ALU.scala:71:36, :89:83, :105:58, :110:{16,23,40,49}
  assign io_out = io_dw ? out : {{32{out[31]}}, out[31:0]};	// src/main/scala/rocket/ALU.scala:110:16, :112:10, :115:{28,37,43,48,56,66}
  assign io_adder_out = _io_adder_out_T_3;	// src/main/scala/rocket/ALU.scala:71:36
