...
module ram_32x18(	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  input  [4:0]  R0_addr,
  input         R0_en,
                R0_clk,
  input  [4:0]  W0_addr,
  ...
  reg [17:0] Memory[0:31];	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 18'bx;	// src/main/scala/chisel3/util/Decoupled.scala:257:91
endmodule
