...
module Repeater_2(
  ...
  input  [6:0]  io_enq_bits_source,	// src/main/scala/util/Repeater.scala:12:14
  ...
  output [6:0]  io_deq_bits_source,	// src/main/scala/util/Repeater.scala:12:14
  ...
  reg  [6:0]  saved_source;	// src/main/scala/util/Repeater.scala:20:18
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_source = _RANDOM[2'h0][16:10];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_address = _RANDOM[2'h0][28:17];	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_mask = {_RANDOM[2'h0][31:29], _RANDOM[2'h1][4:0]};	// src/main/scala/util/Repeater.scala:19:21, :20:18
        saved_data = {_RANDOM[2'h1][31:5], _RANDOM[2'h2], _RANDOM[2'h3][4:0]};	// src/main/scala/util/Repeater.scala:20:18
        saved_corrupt = _RANDOM[2'h3][5];	// src/main/scala/util/Repeater.scala:20:18
      `endif // RANDOMIZE_REG_INIT
    end // initial
