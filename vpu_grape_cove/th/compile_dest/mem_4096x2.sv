...
module mem_4096x2(	// src/main/scala/util/DescribedSRAM.scala:17:26
  input  [11:0] RW0_addr,
  input         RW0_en,
                RW0_clk,
                RW0_wmode,
  ...
  reg [1:0]  Memory[0:4095];	// src/main/scala/util/DescribedSRAM.scala:17:26
  reg [11:0] _RW0_raddr_d0;	// src/main/scala/util/DescribedSRAM.scala:17:26
  ...
  `ifdef ENABLE_INITIAL_MEM_	// src/main/scala/util/DescribedSRAM.scala:17:26
    ...
    initial begin	// src/main/scala/util/DescribedSRAM.scala:17:26
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/util/DescribedSRAM.scala:17:26
        ...
        _RW0_raddr_d0 = _RANDOM[11:0];	// src/main/scala/util/DescribedSRAM.scala:17:26
        _RW0_ren_d0 = _RANDOM[12];	// src/main/scala/util/DescribedSRAM.scala:17:26
        _RW0_rmode_d0 = _RANDOM[13];	// src/main/scala/util/DescribedSRAM.scala:17:26
      `endif // RANDOMIZE_REG_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign RW0_rdata = _RW0_ren_d0 & ~_RW0_rmode_d0 ? Memory[_RW0_raddr_d0] : 2'bx;	// src/main/scala/util/DescribedSRAM.scala:17:26
endmodule
