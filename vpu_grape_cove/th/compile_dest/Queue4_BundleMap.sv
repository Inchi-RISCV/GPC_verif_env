...
module Queue4_BundleMap(
  ...
  input  [6:0] io_enq_bits_extra_id,	// src/main/scala/chisel3/util/Decoupled.scala:256:14
  input        io_enq_bits_real_last,	// src/main/scala/chisel3/util/Decoupled.scala:256:14
  ...
  output [6:0] io_deq_bits_extra_id,	// src/main/scala/chisel3/util/Decoupled.scala:256:14
  output       io_deq_bits_real_last	// src/main/scala/chisel3/util/Decoupled.scala:256:14
);

  wire [7:0] _ram_ext_R0_data;	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  ...
  wire [1:0] ptr_diff = enq_ptr_value - deq_ptr_value;	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:310:32
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        maybe_full = _RANDOM[/*Zero width*/ 1'b0][4];	// src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:260:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_4x8 ram_ext (	// src/main/scala/chisel3/util/Decoupled.scala:257:91
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_real_last, io_enq_bits_extra_id}),	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  ...
  assign io_deq_bits_extra_id = _ram_ext_R0_data[6:0];	// src/main/scala/chisel3/util/Decoupled.scala:257:91
  assign io_deq_bits_real_last = _ram_ext_R0_data[7];	// src/main/scala/chisel3/util/Decoupled.scala:257:91
endmodule
